...
Dir <- here::here()
DF = data.table::fread(file.path(Dir,'csv_output/proportion_visits.csv'), header = TRUE)
...
PlotAll = ggtern(DFplot, aes(Slow,Medium,Fast)) +
  ...
  scale_color_manual("Choice condition", labels = c("Forced", "Free"), values = c(rgb(255/255,140/255,0/255), rgb(86/255,180/255,233/255))) +
