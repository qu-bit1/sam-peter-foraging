% Code to reproduce the reward prior for leaving for free or forced choice conditions (Figure 4A)
...
writetable(T,['csv_output' fs 'reward_before_leaving.csv']);
...
analysisname='Fig4A_rewB4Leaving';
